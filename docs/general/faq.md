...
- [How to keep my project up-to-date with `react-native-boilerplate`?](#how-to-keep-my-project-up-to-date-with-react-native-boilerplate)
...
## How to keep my project up-to-date with `react-native-boilerplate`?

While it's possible to keep your project up-to-date or "in sync" with `react-native-boilerplate`, it's usually
...
Submit an [issue](https://github.com/keremcubuk/react-native-boilerplate/issues),
hop onto the [Discord chat](https://discord.gg/8aCkVA)
or contact Kerem direct on [twitter](https://twitter.com/keremcubuk)!
