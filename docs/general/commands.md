...
Starts the development server running on `http://localhost:8081`
...
`localhost:8081`. Changes in the application code will be hot-reloaded.
...
See the [testing documentation](/docs/testing) for detailed information
